...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <h1 class="page-header">tour_photos</h1>
...
<!-- /.row -->
<h5 class="page-header"><a href="/tourPhotos/create" class="btn btn-primary btn-xs">Add tour_photos </a></h5><!-- page-header -->
    ...
    <tbody>
        ...
        <td>{{$U->title}}</td>
           ...
           <td>{{$U->img}}</td>
            ...
            <td><a href="/tourPhotos/{{$U->id}}/destroy" class="btn btn-danger btn-xs">delete</a></td>
