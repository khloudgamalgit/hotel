            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                    <form action="/bookings/update/{{$booking->id}}" method="POST" enctype="multipart/form-data">
                                 ...
                                 <div class="row">
                                        <div class="col-md-6">
                                                <div class="form-group {{ $errors->has('time_from') ? ' has-error' : '' }}">
                                                    ...
                                                    <input type="date" name="time_from" class="form-control" value="{{$date}}">
                                                ...
                                                <div class="col-md-6">
                                                        <div class="form-group {{ $errors->has('time_to') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type="date" name="time_to" class="form-control" value="{{$date1}}">
                ...
                <label for="customer_name" class=" control-label"> Select Customer :</label>
                    ...
                    <option disabled selected value> -- Select Customer -- </option>
                        ...
                        <option value="{{$R->id}}" @if($R->first_name === $bookings->first_name){{'selected'}}@endif>{{$R->first_name}}</option>
                        @endforeach
            ...
            <div class="form-group{{ $errors->has('room_number') ? ' has-error' : '' }}">
                <label for="room_number" class=" control-label"> Select room_number :</label>
                    ...
                    <option disabled selected value> -- Select room_number -- </option>
                        ...
                        @foreach($rooms as $R) 
                        <option value="{{$R->id}}" @if($R->room_number === $bookings->room_number) {{'selected'}}@endif>{{$R->room_number}}</option>
                        @endforeach
              ...
              <label for="additional_information">	additional_information :</label>
                    <textarea class="form-control" name="additional_information" rows="10">{{$booking->additional_information}}</textarea>
