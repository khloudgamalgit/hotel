...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <h1 class="page-header">Accept Bookings</h1>
...
<table class="table table-striped table-bordered table-hover">
    ...
    @foreach($booking_acceptance as $U)
    <tbody>
        ...
        <tr>
           ...
           <td style="text-align:center;">
                 ...
                 <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#m-{{$U->booking_id}}">Show Description</button>

                <!-- Modal -->
                <div id="m-{{$U->booking_id}}" class="modal fade" role="dialog">
               ...
               <td style="text-align:center;">
                @if ($U->is_active == 0)
                 ...
                 <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#m2-{{$U->booking_id}}">Disactive</button>

                <!-- Modal -->
                <div id="m2-{{$U->booking_id}}" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                            <a href="/accept_bookings/{{$U->booking_id}}/activation" class="btn btn-success">Active</a>
                                 <button type="button" class="btn btn-warning" data-dismiss="modal">
                                      <span class='glyphicon glyphicon-remove'></span> Close
                                    </button>
                            </div>
                ...
                @else
                   ...
                   <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#m1-{{$U->booking_id}}"> Active</button>

                <!-- Modal -->
                <div id="m1-{{$U->booking_id}}" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                             <a href="/accept_bookings/{{$U->booking_id}}/activation" class="btn btn-danger">Disactive</a>
                                 <button type="button" class="btn btn-warning" data-dismiss="modal">
                                      <span class='glyphicon glyphicon-remove'></span> Close
                                    </button>
                            </div>
...
@endif
 <td>{{$U->created_at}}</td>
            ...
            <td><a href="/booking_acceptance/{{$U->booking_id}}/destroyAcceptance" class="btn btn-danger btn-xs">reject</a></td>
