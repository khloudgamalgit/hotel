...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <h1 class="page-header">room_photos</h1>
...
<!-- /.row -->
<h5 class="page-header"><a href="/roomPhotos/create" class="btn btn-primary btn-xs">Add room_photos </a></h5><!-- page-header -->
...
<table class="table table-striped table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
              ...
              <td>{{$U->img}}</td>
              <td>{{$U->created_at}}  </td>
            <td><a href="/roomPhotos/{{$U->id}}/destroy" class="btn btn-danger btn-xs">delete</a></td>
