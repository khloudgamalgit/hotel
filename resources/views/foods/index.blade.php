...
<!-- /.row -->
<h5 class="page-header"><a href="/foods/create" class="btn btn-primary btn-xs">Add foods </a></h5><!-- page-header -->
...
<table class="table table-striped table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="/foods/{{$U->id}}/destroy" class="btn btn-danger btn-xs">delete</a></td>
