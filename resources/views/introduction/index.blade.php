...
<!-- /.row -->
<h5 class="page-header"><a href="/introduction/create" class="btn btn-primary btn-xs">Add Introduction </a></h5><!-- page-header -->
...
<table class="table table-striped table-bordered table-hover">
    ...
    <tbody>
        ...
        <td style="text-align:center;">
            ...
            <td><a href="/introduction/edit/{{$U->id}}" class="btn btn-success btn-xs">edit</a></td>
            <td><a href="/introduction/{{$U->id}}/destroy" class="btn btn-danger btn-xs">delete</a></td>
