...
<!-- /.row -->
<h5 class="page-header"><a href="/drinks/create" class="btn btn-primary btn-xs">Add drinks </a></h5><!-- page-header -->
...
<table class="table table-striped table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="/drinks/{{$U->id}}/destroy" class="btn btn-danger btn-xs">delete</a></td>
