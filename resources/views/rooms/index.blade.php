...
<!-- /.row -->
<h5 class="page-header"><a href="/rooms/create" class="btn btn-primary btn-xs">Add Rooms  </a></h5><!-- page-header -->
    ...
    <tbody>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
             ...
             <h4 class="modal-title">Show Description</h4>
                            </div>
            ...
            <td><a href="/rooms/edit/{{$U->id}}" class="btn btn-success btn-xs">edit</a></td>
            <td><a href="/rooms/{{$U->id}}/destroy" class="btn btn-danger btn-xs">delete</a></td>
